      ...
      >
        <div className={`flex items-center justify-between ${scrolled ? 'gap-8' : 'max-w-[1600px] mx-auto w-full'}`}>
            ...
            <a href="#" className="relative group z-50">
                <span className={`font-black uppercase tracking-tighter transition-all duration-300 flex flex-col leading-none ${
                    scrolled ? 'text-lg text-gray-900' : 'text-xl md:text-2xl text-gray-900'
                }`}>
