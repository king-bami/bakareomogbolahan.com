...
import { ExternalLink, ArrowRight, Lock, ShieldCheck, MapPin, Brain, Activity, Zap, Database, Globe, Award, Banknote, Cloud } from 'lucide-react';
          ...
          >
            ...
            >
                <div className="bg-[#0f172a] rounded-[1.5rem] h-full p-8 md:p-12 flex flex-col md:flex-row gap-12 overflow-hidden relative">
                    ...
                    {/* Visual */}
                    <motion.div 
                        className="w-full md:w-[450px] aspect-video md:aspect-auto rounded-xl overflow-hidden shadow-2xl border border-slate-700 bg-slate-900 relative"
                        whileHover={{ scale: 1.02 }}
                        transition={{ duration: 0.4 }}
                    >
                         <div className="absolute top-0 left-0 w-full h-8 bg-slate-800 flex items-center px-4 gap-2 z-10 border-b border-slate-700">
          ...
          >
            ...
            >
                <div className="bg-gray-900 rounded-[1.5rem] h-full p-8 md:p-10 flex flex-col md:flex-row gap-8 overflow-hidden relative">
                    ...
                    {/* Visual */}
                    <motion.div 
                        className="w-full md:w-1/2 aspect-square md:aspect-auto rounded-xl overflow-hidden shadow-2xl border border-gray-700 bg-black/50"
                        whileHover={{ scale: 1.02 }}
                        transition={{ duration: 0.4 }}
                    >
                        <GeoAnimation />
